  ...
  return (
    <>
      ...
      <div className="min-h-screen relative bg-white dark:bg-gray-900">
        ...
        <div className="mx-auto flex justify-center max-w-screen-xl py-8 blogHeader">
          {/* vlog header map function */}
          <div className="px-0.5 md:px-7 pb-14 pt-2 mx-auto mx-3 dark:bg-gray-800 bg-green-50 blgHed">
            <h1 className="pl-10  font-bold text-indigo-500">
              RECENTLY PUBLISHED
            </h1>
          ...
          <div className=" md:w-11/12 lg:w-11/12 xl:w-9/12 dark:bg-gray-800 bg-red-50 tagCoc">
            <nav className="sticky top-32 overflow-auto toc-inner ">
              <h1 className=" m-2 mb-5 font-bold text-indigo-500">
                CATEGORIES
              </h1>
              ...
              {blogs.map((blog, index) => (
                <button
                  ...
                  onClick={() => {
                    ...
                    console.log(
                      `selected tag: ${blog.data.Tags.split(" ")[1]}`
                    );
                    const filterData = blogs.filter(
                      (dat) =>
                        dat.data.Tags.split(" ")[1] ===
