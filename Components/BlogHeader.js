...
function BlogHeader({data, content, readTime}) {
  return (
    ...
    >
      <div className="cursor-pointer group px-6 py-6 md:px-10 md:w-1/2 flex flex-col items-start rounded transform">
      <div className="flex items-center flex-wrap pb-2 mt-auto w-full justify-between dark:border-indigo-400">
