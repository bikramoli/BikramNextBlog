          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center -mx-2">
              ...
              >
                ...
                <span className="text-lg">
                    <Online><BiWifi className="text-lg" /></Online>
                    <Offline><BiWifiOff className="text-lg" /></Offline>
                </span>
              </a>
              ...
              <span className="text-lg">
                  ...
                  <div className="flex-shrink-0 mr-1.5 md:mr-3 im">
                    <div className="dropdown inline-block relative">
                      ...
                      <span className="mr-1">
                        <img className="mt-0 rounded-full w-8 h-8 sm:w-8 sm:h-8"
                          src={photo}
                          alt={name}/>
                      </span>
                        <AiFillDownSquare/>
                      ...
                      <ul className="dropdown-menu absolute hidden text-gray-700 pt-1">
                        <li><a className="rounded-t bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" >setting</a></li>
                        <li>
                          <a className="bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" onClick={handelSignOut}>
                            Logout
                          </a>
                        </li>
                      </ul>
